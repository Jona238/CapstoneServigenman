...
"[project]/src/app/inventario/interaction.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const BACKEND_URL = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" // same-origin: rely on Next.js rewrite for /api/*
 : typeof process !== "undefined" && process.env && (("TURBOPACK compile-time value", "http://localhost:8000") || process.env.NEXT_PUBLIC_BACKEND_URL) || "http://localhost:8000";
...
async function bootstrapInventario() {
    ...
    if (!Array.isArray(cats) || !cats.length) {
        const set = new Set((data ?? []).map((item)=>item?.categoria).filter((value)=>Boolean(value)));
...
function filtrarTabla({ resetPage = true } = {}) {
    ...
    const inputInfo = (document.getElementById("filtroInfo")?.value || "").toLowerCase();
...
async function guardarFila(button) {
    ...
    const nuevaCantidad = Number.parseInt(celdas[3]?.querySelector("input")?.value || "0", 10);
    const nuevoPrecio = Number.parseFloat(celdas[4]?.querySelector("input")?.value || "0");
    const fileInput = celdas[5]?.querySelector("input[type='file']");
    const imgElement = celdas[5]?.querySelector("img");
    const nuevaInfo = celdas[6]?.querySelector("input")?.value.trim() ?? "";
...
async function agregarRecurso(event) {
    ...
    const cantidad = Number.parseInt(document.getElementById("nuevaCantidad")?.value || "0", 10);
    const precio = Number.parseFloat(document.getElementById("nuevoPrecio")?.value || "0");
    const file = document.getElementById("nuevaFoto")?.files?.[0] ?? null;
    const info = document.getElementById("nuevaInfo")?.value.trim() ?? "";
...
"[project]/src/app/inventario/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$inventario$2f$interaction$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/inventario/interaction.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function InventoryPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const cleanup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$inventario$2f$interaction$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initializeInventoryPage"])();
        return ()=>{
            cleanup();
        };
    }, []);
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                isDeveloper && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7de29657._.js.map