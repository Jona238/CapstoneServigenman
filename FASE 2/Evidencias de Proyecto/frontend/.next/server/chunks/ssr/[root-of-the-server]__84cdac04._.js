...
"[project]/src/app/categorias/interaction.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function summarizeCategory(name, inventory) {
    ...
    const totalValue = items.reduce((acc, item)=>acc + (item.cantidad ?? 0) * (item.precio ?? 0), 0);
    const topResource = items.slice().sort((a, b)=>(b.cantidad ?? 0) - (a.cantidad ?? 0))[0]?.recurso;
    return {
        name,
        resourceCount,
        totalQuantity,
...
"[project]/src/app/categorias/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$categorias$2f$interaction$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/categorias/interaction.ts [app-ssr] (ecmascript)");
"use client";
;
;
;
...
function CategoriesPage() {
    ...
    const apiBaseUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        const sanitize = (u)=>u.replace(/\/+$/, "");
        const env = ("TURBOPACK compile-time value", "http://localhost:8000")?.trim();
        if (env) return sanitize(env);
        if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
        ;
        return "";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const cleanup = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$categorias$2f$interaction$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initializeCategoriesPage"])();
        return ()=>{
            cleanup();
        };
    }, []);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__84cdac04._.js.map