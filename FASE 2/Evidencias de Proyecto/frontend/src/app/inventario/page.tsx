          ...
          <main className="inventory-main">
            <section className="inventory-card">
              ...
              <div className="tabla-scroll">
                ...
                <div id="tablaVacia" className="tabla-vacia" hidden>
                  <EstadoVacio description="Agrega recursos o ajusta los filtros para visualizar resultados." />
                </div>
              </div>
