...
def _get_list(value: str | None, default: list[str]) -> list[str]:
    if not value:
        return default
...
SECRET_KEY = os.getenv(
    "DJANGO_SECRET_KEY",
    'django-insecure-vw!kg+l!#sb7a4dvrjrh3dg#1&75kxj_41$g!=du363*1#jdea',
)
...
# Media (para posibles subidas en el futuro)
MEDIA_URL = '/media/'
